...
int main()
{
  ...
  for (int k = 4; k < viscos_rat_data.size(); k++)
    {
      viscos_convert << "viscos_rat=" << viscos_rat_data[k];
  ...
  for (int j = 2; j < bond_data.size(); j++)
    {
      ...
      for (int k = 5; k < viscos_rat_data.size(); k++)
	{
	  viscos_convert << "viscos_rat=" << viscos_rat_data[k];
  ...
  for (int k = 3; k < viscos_rat_data.size(); k++)
    {
      viscos_convert << "viscos_rat=" << viscos_rat_data[k];
  ...
  //D=1000
  D_convert << "D=" << mod_dens_rat_data[3];
