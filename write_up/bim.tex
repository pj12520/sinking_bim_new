...
The value of the timestep chosen is limited by the Courant-Friedrich-Lewy (CFL) criterion \citep{Courant28}, and physically to ensure the timestep is less than the timescale over which the system geometry changes (see quasi-static assumption - equation~\ref{equ:quasi_stat}).
